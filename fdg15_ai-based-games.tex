...
\alignauthor Mirjam P. Eladhari\\
	...
	\affaddr{Institute of Digital Games}\\
	\affaddr{Msida, Malta}\\
	\email{mirjame@gmail.com}
...
\additionalauthors{
Additional author: Alex Zook (School of Interactive Computing, Georgia Institute of Technology), email: {\texttt{a.zook@gatech.edu}}.	
}
